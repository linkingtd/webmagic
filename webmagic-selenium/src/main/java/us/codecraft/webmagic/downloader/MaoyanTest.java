...
import us.codecraft.webmagic.downloader.util.ImageUtil;
import us.codecraft.webmagic.downloader.util.TesseractOcrUtil;
...
//				wait.until(ExpectedConditions.presenceOfElementLocated(By.id("J_PromoPriceNum")));
				...
				String srcfile = "E:\\test\\" + UUID.randomUUID().toString() + ".png";
				...
				for (int i = 1; i < movielist.size(); i++) {
					...
					String cop_path = "E:\\test\\current_piaofang_" + movieName + ".png";
					...
					FileUtils.deleteDirectory(new File(srcfile));
				}
			} catch (Exception e) {
				e.printStackTrace();
			} 
